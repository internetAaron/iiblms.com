...
Take a look at Premium **[Education WordPress Theme](http://themeforest.net/item/education-wordpress-theme-education-wp/14058034?utm_source=wporg&utm_medium=banner&ref=thimpress&utm_campaign=learnpress)** & **[LMS WordPress Theme](http://themeforest.net/item/lms-wordpress-theme-elearning-wp/11797847?utm_source=wporg&utm_medium=banner&ref=thimpress&utm_campaign=learnpress)** (someone calls it LMS WordPress Template) we designed to work with LearnPress, all developers are welcome to develop WordPress LMS Theme based on LMS plugin for WordPress - LearnPress. More WordPress LMS Themes will come soon, both free WordPress themes as well as premium WordPress themes for LearnPress.
...
- Fixed problem with Check Answer button.
- Updated related courses function.
- Made archive quizzes page and archive lessons page to 404 page.
- Fixed problems with quiz duration.
- Fixed PHP notice when no courses data is set.

= 0.9.18 =
- Fixed question explanation not showing up.
- Fixed search query error with search keyword is empty.
- Fixed remove the number output in header.
- Added some untranslated strings.

= 0.9.17 =
- Fixed update question title is incorrect.

= 0.9.16 =
- Fixed students counter is incorrect.
- Fixed javascript trigger error in learnpress.js.
- Fixed fatal error in add-ons page.
- Fixed missing style in add-ons page with version of WordPress lower 4.0.
